...
class QuestionMatch extends React.Component {
    constructor(props) {
        ...
        addEventListener("progress_changed", this.progress_changed.bind(this))
    }
...
export class Story extends React.Component {
    constructor(props) {
        ...
        addEventListener("story_id_changed", this.story_id_changed.bind(this))
        if(this.props.story)
            this.loadData(this.props.story)
    }
