...
Duostories is not link the software Word where you edit the final output directly, but you write
the stories in some kind of "coding" language that will be then converted to the final story display.
...
### Save
You can save a story with a click on the save symbol. Changes
...
<Info>In some legacy stories you still see some character icon or speaker definitions here.
They are only for compatibility with old stories and should not be used in new story translations.</Info>