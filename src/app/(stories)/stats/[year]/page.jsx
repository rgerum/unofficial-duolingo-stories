...
import StatsElement from "./[month]/stats_element";
import StatsElement2 from "./[month]/stats_element2";
...
export default async function Page({ params }) {
  ...
  const data = await get_stats(year);
  data.year = year;
  const data_old = await get_stats(year - 1);
  data_old.year = year - 1;
