...
<Warning>The course needs to be set to "no-audio" by an admin. This will disable the listening mode and warnings about
missing audio. Feel free to ask a moderator in discord to enable this flag for the course.</Warning>
