...
const batchDirs = args.batchDir.length
  ? args.batchDir
    : [
        "/home/codex/forced-alignment-batches/da-en-prod-all-20260612-190037",
        "/home/codex/forced-alignment-batches/da-en-prod-failed-rerun-20260615-134756",
        "/home/codex/forced-alignment-batches/da-en-prod-audio-drift-rerun-20260625-final",
      ];
const shouldApply = args.apply === true;
const publicOnly = args.includePrivate !== true;
const forcedAlignmentComment = `# Forced alignment: Danish human-audio word timings applied ${new Date()
  .toISOString()
  .slice(0, 10)} from batches da-en-prod-all-20260612-190037, da-en-prod-failed-rerun-20260615-134756, and da-en-prod-audio-drift-rerun-20260625-final.`;
const reportPath =
  args.report ??
  path.join(
    "tmp",
    `apply-danish-forced-alignments-${shouldApply ? "apply" : "dry-run"}.json`,
  );
...
Applies saved Danish forced-alignment result files through storyWrite.setStory.
...
Options:
  ...
  --apply                Actually write to Convex prod.
  --help                 Show this help.
