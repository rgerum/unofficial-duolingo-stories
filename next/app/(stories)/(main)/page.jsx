...
function IconDiscord() {
    return <svg viewBox="0 0 512 512" width="32" height="32" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle style={{fill:"var(--text-color)"}} cx="308.31046" cy="273.13742" r="30.676001" />
        <circle style={{fill:"var(--text-color)"}} cx="203.6895" cy="273.13742" r="30.676001" />
    </svg>
}

function IconGithub() {
    return <svg height="32px" viewBox="0 0 32 32" width="32px" xmlns="http://www.w3.org/2000/svg">
...
function IconOpenCollective() {
    return <svg height="32" viewBox="0 0 24 24" width="32" xmlns="http://www.w3.org/2000/svg">
        <path style={{fill:"var(--text-color)"}} d="M16.6818 15.7529L18.8116 17.8827C20.1752 16.3052 21 14.249 21 12.0001C21 9.78747 20.2016 7.76133 18.8771 6.19409L16.7444 8.32671C17.5315 9.34177 18 10.6162 18 12.0001C18 13.4203 17.5066 14.7253 16.6818 15.7529Z" fill="currentColor" fill-opacity="0.5"/>
...
function IconInstagram() {
    return <svg height="32"  width="32" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
...
export default async function Page({ }) {
    ...
    return <>
        <Header>
            ...
            <p>
                <Link href="https://discord.gg/4NGVScARR3"><IconDiscord/></Link>
                &nbsp;&nbsp;
                <Link href="https://github.com/rgerum/unofficial-duolingo-stories"><IconGithub/></Link>
                &nbsp;&nbsp;
                <Link href="https://opencollective.com/duostories"><IconOpenCollective /></Link>
                &nbsp;&nbsp;
                <Link href="https://www.instagram.com/duostoriesproject/"><IconInstagram /></Link>
                &nbsp;&nbsp;
                <Link href="https://twitter.com/DuostoriesNews"><IconTwitter /></Link>
