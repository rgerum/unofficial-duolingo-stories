...
export default async function Page() {
    ...
    return <>
        ...
        <p>Yes, we asked Duolingo for permission and came to an agreement that we are allowed to use the
        ...
        <p>The website was developed by me, "randrian". You can find me on <Link href="https://www.duolingo.com/profile/Randriano">Duolingo</Link> or on <Link href="https://github.com/rgerum">Github</Link>.
