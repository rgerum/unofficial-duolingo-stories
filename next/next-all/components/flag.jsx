...
export default function Flag(props) {
    ...
    if(props.flag_file) {
        return <svg className={styles.flag} viewBox={`-2 -2 82 66`} data-test={`flag-${props.iso}`} style={style}>
            <image height="62"
    ...
    return <svg className={styles.flag} viewBox={`0 ${count} 82 66`} data-test={`flag-${props.iso}`} style={style}>
        <image height="3168"
