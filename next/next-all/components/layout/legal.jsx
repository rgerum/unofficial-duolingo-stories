...
export default function Legal({language_name}) {
    return <small className={styles.legal}>
        ...
        id="license_language">{language_name ? "into "+language_name : ""}</span> and this is not an official product of Duolingo.<br/>
        Any further use of these stories requires a license from Duolingo.<br/>
        Visit <Link href="https://www.duolingo.com">www.duolingo.com</Link> for more
        information.
    </small>
}